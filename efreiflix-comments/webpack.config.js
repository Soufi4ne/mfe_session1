/**
 * Configuration Webpack pour le micro-frontend de Commentaires
 *
 * Ce fichier configure un micro-frontend qui sera consommé par l'application Shell.
 * Il expose un composant Comments qui pourra être importé dynamiquement.
 */
...
module.exports = {
  ...
  output: {
    ...
    publicPath: "http://localhost:3003/", // URL publique de base pour les assets (port unique)
  },
  devServer: {
    port: 3003, // Port du serveur de développement (unique pour chaque MFE)
    static: {
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: "comments", // Nom UNIQUE du Micro Frontend
      ...
      exposes: {
        "./Comments": "./src/Comments", // Expose le composant Comments
      },
      shared: {
